            ...
            <form class="form-horizontal" method="post"
                ...
                <div class="row">
                    <div class="form-group col-xs-6">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control" type="text" name="user_address" value="<?php echo $is_edit?$info_data['user_address']:''; ?>">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control" type="text" name="user_changeman" value="<?php echo $_SESSION['user_name']; ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
