            ...
            <form class="form-horizontal" method="post"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control" name="care_theme" type="text"
                            value="<?php echo $is_edit?$care_info_data['care_theme']:''; ?>">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-xs-6">
                        ...
                        <div class="col-sm-8">
                            ...
                            value="<?php echo $is_edit?$care_info_data['care_nexttime']:''; ?>" name="care_nexttime" readonly>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" name="care_remark" rows="3">
                        <?php echo $is_edit?$care_info_data['care_remark']:''; ?>
                        </textarea>
                    </div>
                </div>
