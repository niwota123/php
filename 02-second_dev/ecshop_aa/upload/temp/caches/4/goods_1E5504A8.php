...
<div id="page-content" class="single-page">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <ul class="breadcrumb">
                    <li><a href=".">首页</a></li>  <li><a href="category.php?id=1">手机类型</a></li>  <li><a href="category.php?id=3">GSM手机</a></li><li>三星BC01                </ul>
            </div>
        </div>
        <div class="row">
            <div id="main-content" class="col-md-8">
                <div class="product">
                    <div class="col-md-6">
                        <div class="image">
                                                        <a href="javascript:;" onclick="window.open('gallery.php?id=20'); return false;">
                                <img src="images/200905/goods_img/20_G_1242106490663.jpg" alt="三星BC01"/>
                            </a>
                            
                            <div class="image-more">
                                <ul class="row">
                                                                        <li class="col-lg-3 col-sm-3 col-xs-4"><a href="gallery.php?id=20&amp;img=38" target="_blank"><img  src="images/200905/thumb_img/20_thumb_P_1242106490836.jpg" alt="三星BC01" class="B_blue img-responsive" /></a>
                                    </li>
                                                                    </ul>
                            </div>
                        </div>
                    ...
                    <form action="javascript:addToCart(20)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
                        <div class="col-md-6">
                            <div class="caption">
                                <div class="name"><h3>三星BC01</h3></div>
                                <div class="info">
                                    <ul>
                                        <li>商品品牌：三星</li>
                                        <li>商品货号：ECS000020</li>
                                                                                                                        <li>商品库存：12 台</li>
                                                                                                                    </ul>
                                </div>
                                <div class="price">280.00<span>￥336元</span></div>
                                
                                                                <strong>颜色:</strong><br />
                                
                                                                                                                                <label for="spec_value_194">
                                    <input type="radio" name="spec_185" value="194" id="spec_value_194" checked onclick="changePrice()" />
                                    黑色 [ ￥0.00元] </label><br />
                                                                <input type="hidden" name="spec_list" value="0" />
                                                                                                                                
                                <div class="well"><label>购买数量：</label> <input class="form-inline quantity" type="text" value="1" name="number"><a href="javascript:addToCart(20)" class="btn btn-2 ">加入购物车</a></div>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="review" class="tab-pane fade">
                            <table class="table table-bordered" bgcolor="#dddddd">
                                    ...
                                    <td bgcolor="#FFFFFF" align="left" width="70%">2008年07月</td>
                                </tr>
                                                                <tr>
                                    <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[手机制式]</td>
                                    <td bgcolor="#FFFFFF" align="left" width="70%">GSM,900,1800,1900,2100</td>
                                </tr>
                                                                                            </table>
                        </div>
                    </div>
                    ...
                    <div class="products">
                            ...
                            <div class="product">
                                ...
                                <div class="caption">
                                    ...
                                    <div class="price">￥399元<span></span></div>
                                </div>
                            </div>
                        </div>
                                                <div class="col-lg-4 col-md-4 col-xs-12">
