...
<div id="page-content" class="single-page">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <ul class="breadcrumb">
                    <li><a href=".">首页</a></li>  <li><a href="category.php?id=1">手机类型</a></li>  <li><a href="category.php?id=3">GSM手机</a></li><li>多普达Touch HD                </ul>
            </div>
        </div>
        <div class="row">
            <div id="main-content" class="col-md-8">
                <div class="product">
                    <div class="col-md-6">
                        <div class="image">
                                                        <a href="javascript:;" onclick="window.open('gallery.php?id=22'); return false;">
                                <img src="images/200905/goods_img/22_G_1241971076358.jpg" alt="多普达Touch HD"/>
                            </a>
                            
                            <div class="image-more">
                                <ul class="row">
                                                                        <li class="col-lg-3 col-sm-3 col-xs-4"><a href="gallery.php?id=22&amp;img=28" target="_blank"><img  src="images/200905/thumb_img/22_thumb_P_1241971076595.jpg" alt="多普达Touch HD" class="B_blue img-responsive" /></a>
                                    </li>
                                                                    </ul>
                            </div>
                        </div>
                    ...
                    <form action="javascript:addToCart(22)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
                        <div class="col-md-6">
                            <div class="caption">
                                <div class="name"><h3>多普达Touch HD</h3></div>
                                <div class="info">
                                    <ul>
                                        <li>商品品牌：多普达</li>
                                        <li>商品货号：ECS000022</li>
                                                                                                                        <li>商品库存：1 台</li>
                                                                                                                    </ul>
                                </div>
                                <div class="price">5999.00<span>￥7199元</span></div>
                                
                                                                <strong>颜色:</strong><br />
                                
                                                                                                                                <label for="spec_value_182">
                                    <input type="radio" name="spec_185" value="182" id="spec_value_182" checked onclick="changePrice()" />
                                    黑色 [ ￥0.00元] </label><br />
...
<p>&nbsp;</p>                        </div>
                        <div id="review" class="tab-pane fade">
                            <table class="table table-bordered" bgcolor="#dddddd">
                                    ...
                                    <td bgcolor="#FFFFFF" align="left" width="70%">2008年12月</td>
                                </tr>
                                                                <tr>
                                    <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[存储卡格式]</td>
                                    <td bgcolor="#FFFFFF" align="left" width="70%">microSD</td>
                                </tr>
                                                                <tr>
                                    <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[内存容量]</td>
                                    <td bgcolor="#FFFFFF" align="left" width="70%">288MB</td>
                                </tr>
                                                                <tr>
                                    ...
                                    <td bgcolor="#FFFFFF" align="left" width="70%">GSM,850,900,1800,1900</td>
                                                                ...
                                                                <tr>
                                    <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[理论通话时间]</td>
                                    <td bgcolor="#FFFFFF" align="left" width="70%">6.5小时</td>
                                </tr>
                                                                <tr>
                                    <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[理论待机时间]</td>
                                    <td bgcolor="#FFFFFF" align="left" width="70%">450小时</td>
                                </tr>
                                                                <tr>
                    ...
                    <div class="heading"><h2>购买过此商品的人还购买过</h2></div>
                    <div class="products">
                            ...
                            <div class="product">
                                ...
                                <div class="caption">
                                    ...
                                    <div class="price">￥2298元<span></span></div>
                                </div>
                            </div>
                        </div>
                                                <div class="col-lg-4 col-md-4 col-xs-12">
