        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav">
                <li><a href="index.php">首页<span></span></a></li>
                                ...
                                <li><a href="category.php?id=6"   class="cur">手机配件<span></span></a></li>
...
<div id="page-content" class="single-page">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <ul class="breadcrumb">
                    <li><a href=".">首页</a></li>  <li><a href="category.php?id=6">手机配件</a></li>  <li><a href="category.php?id=8">耳机</a></li><li>诺基亚原装5800耳机                </ul>
            </div>
        </div>
        <div class="row">
            <div id="main-content" class="col-md-8">
                <div class="product">
                    <div class="col-md-6">
                        <div class="image">
                                                        <a href="javascript:;" onclick="window.open('gallery.php?id=3'); return false;">
                                <img src="images/200905/goods_img/3_G_1241422082168.jpg" alt="诺基亚原装5800耳机"/>
                            </a>
                            
                            <div class="image-more">
                                <ul class="row">
                                                                        <li class="col-lg-3 col-sm-3 col-xs-4"><a href="gallery.php?id=3&amp;img=6" target="_blank"><img  src="images/200905/thumb_img/3_thumb_P_1241422082160.jpg" alt="诺基亚原装5800耳机" class="B_blue img-responsive" /></a>
                                    </li>
                                                                    </ul>
                            </div>
                        </div>
                    ...
                    <form action="javascript:addToCart(3)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
                        <div class="col-md-6">
                            <div class="caption">
                                <div class="name"><h3>诺基亚原装5800耳机</h3></div>
                                <div class="info">
                                    <ul>
                                        <li>商品品牌：诺基亚</li>
                                        <li>商品货号：ECS000002</li>
                                                                                                                        <li>商品库存：24 </li>
                                                                                                                    </ul>
                                </div>
                                <div class="price">68.00<span>￥82元</span></div>
                                
                                                                
                                <div class="well"><label>购买数量：</label> <input class="form-inline quantity" type="text" value="1" name="number"><a href="javascript:addToCart(3)" class="btn btn-2 ">加入购物车</a></div>
