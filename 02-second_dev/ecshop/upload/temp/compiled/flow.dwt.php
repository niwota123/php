...
?>
        <div class="row">
            <div class="product well">
                ...
                <div class="col-md-9">
                    <div class="caption">
                        <div class="name"><h3><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="f6"><?php echo $this->_var['goods']['goods_name']; ?></a></h3></div>
                        <div class="info">
                            <ul>
                                ...
                                <li><?php echo $this->_var['lang']['goods_attr']; ?>:<br><?php echo nl2br($this->_var['goods']['goods_attr']); ?></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                        <div class="price"><?php echo $this->_var['goods']['goods_price']; ?><span><?php echo $this->_var['goods']['market_price']; ?></span></div>
                        <label><?php echo $this->_var['lang']['number']; ?>: </label>

                        <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['is_gift'] == 0 && $this->_var['goods']['parent_id'] == 0): ?>
                        <input type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="4" onblur="update_price(this)" class="form-inline quantity" /><a href="#" class="btn btn-2 ">Update</a>
                        <?php else: ?>
                        ...
                        <script>
                            function update_price(obj) {
                                ...
                                $.ajax({
                                    url:'flow.php',
                                    type:'post',
                                    data:'step=update_cart&'+$(obj).attr('name')+'='+$(obj).val(),
                                    dataType:'JSON',
                            ...
                            function update_response(res) {
                                var content = null;
                                <?php if ($this->_var['discount'] > 0): ?>
                                content = <?php echo $this->_var['your_discount']; ?>
                                <?php endif; ?>
                                content =res.shopping_money;
                                <?php if ($this->_var['show_marketprice']): ?>
                                content =res.shopping_money+'，'+res.market_price_desc;
                                <?php endif; ?>
                                alert(content);
                        ...
                        <hr>
                        <a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; " class="btn btn-default pull-right"><?php echo $this->_var['lang']['drop']; ?></a>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
        ...
        <div class="row">
            <div class="pricedetails">
                <div class="col-md-4 col-md-offset-8">
                    <table>
                        <td bgcolor="#ffffff" class="total_price">
                    ...
                    <center><a href="flow.php?step=checkout" class="btn btn-1">Checkout</a></center>
                </div>
            </div>
        </div>
    </div>
...
?>
    ...
    <div class="flowBox">
        ...
        <div align="center" style="margin:8px auto;">
            <input type="image" src="themes/default_zy/images/bnt_subOrder.gif" />
